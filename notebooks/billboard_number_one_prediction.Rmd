...
The linear regression model shows weak predictive performance for explaining the number of weeks a song remains at number one on the Billboard chart. Cross-validation produced an average $R^2 = 0.063$ with `RMSE = 0.505` and `MAE = 0.415`, while evaluation on the test set yielded similar results ($R^2 = 0.063$, `RMSE = 0.505`, `MAE = 0.395`). The similarity between cross-validation and test metrics suggests that the model generalizes consistently and does not suffer from substantial overfitting. However, the low $R^2$ values indicate that the predictors explain only a small portion of the variation in chart longevity.
