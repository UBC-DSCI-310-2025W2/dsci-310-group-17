...
The magazine 'Billboard' is a leading source of information on trends in music popularity and innovation. Following the launch of Billboard.com, weekly rankings of the top 100 songs in the world have been made publically available. (Billboard, nd.) In this analysis, we use linear regression on this data to predict the number of weeks a song remains at the number 1 spot in the rankings. 
